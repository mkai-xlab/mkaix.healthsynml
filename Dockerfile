...
# Runtime model settings come from the Compose env_file. This internal path only
# keeps Ultralytics configuration in a writable location for the non-root user.
