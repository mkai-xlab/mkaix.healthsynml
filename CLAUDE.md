...
This project is indexed by GitNexus as **mkaix.healthsynml** (1469 symbols, 2090 relationships, 35 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
